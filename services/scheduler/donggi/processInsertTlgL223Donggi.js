...
const processInsertTlgL223Donggi = async () => {
    try {
        ...
        const isTableExist = await tlgTableCheck('L223', yy)

        if(isTableExist){

            insertToTlg('L223', yy, formattedDate, formattedTimestamp, outputRealtimeDonggi)
        }


    } catch (err) {
        console.log('err processInsertTlgL223Donggi', err)
    }
}

module.exports = processInsertTlgL223Donggi;