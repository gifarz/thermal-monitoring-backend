...
const processInsertTlgL22Matindok = async () => {
    try {
        ...
        const isTableExist = await tlgTableCheck('L22', yy)

        if(isTableExist){

            insertToTlg('L22', yy, formattedDate, formattedTimestamp, outputRealtimeMatindok)
        }


    } catch (err) {
        console.log('err processInsertTlgL22Matindok', err)
    }
}

module.exports = processInsertTlgL22Matindok;