...
const processInsertTlgL23Matindok = async () => {
    try {
        ...
        const isTableExist = await tlgTableCheck('L23', yy)

        if(isTableExist){

            insertToTlg('L23', yy, formattedDate, formattedTimestamp, outputRealtimeMatindok)
        }


    } catch (err) {
        console.log('err processInsertTlgL23Matindok', err)
    }
}

module.exports = processInsertTlgL23Matindok;