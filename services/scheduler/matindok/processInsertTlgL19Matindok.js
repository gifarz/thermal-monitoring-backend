...
const processInsertTlgL19Matindok = async () => {
    try {
        ...
        const isTableExist = await tlgTableCheck('L19', yy)

        if(isTableExist){

            insertToTlg('L19', yy, formattedDate, formattedTimestamp, outputRealtimeMatindok)
        }


    } catch (err) {
        console.log('err processInsertTlgL19Matindok', err)
    }
}

module.exports = processInsertTlgL19Matindok;